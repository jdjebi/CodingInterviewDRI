...
/**
 * Classe representation la resolution du probleme 1
...
public class Probleme1 {
	 ...
	 * @return nombre d'occurence. -1 si aucune occurence n'est trouvé
	 */
	public static int rechercherOccurences(String [] book, String word) {
        ...
        for(String w: book) { 	
        	if(w.equals(word)) counter += 1; // Si une occurence est trouvé alors on incremente le compteur
        }
